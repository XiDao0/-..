#ifndef BRKS_COMMON_DATASEVER_SQLTABLES_H_
...
public:
	...
	bool CreateUserInfo()
	{
		const char* pUserInfoTable =	" \
										...
										mobile		varchar(16)			NOT NULL default '18111149588', \
	...
	bool CreateBikeTable()
	{
		const char* pBikeInfoTable = " \
										...
										truble		int					NOT NULL default 0, \
										tmsg		varchar(256)		NOT NULL default '',\
										latitude	double(10, 6)		NOT NULL default 0.0, \
										longitude	double(10, 6)		NOT NULL default 0.0, \
										unique KEY  unique_devno (devno) \
										)";
...
#endif // !BRKS_COMMON_DATASEVER_SQLTABLES_H_
